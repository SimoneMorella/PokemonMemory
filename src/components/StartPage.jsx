      ...
      <div>
        <div className="flex flex-col gap-20 -mt-20">
          <motion.div 
            ...
            <img src={logo} alt="pokemon logo" className="max-w-[350px] md:max-w-[450px]" />
            <img src={logo2} alt="pokemon logo" className="max-w-[200px] md:max-w-[250px] absolute right-0 -bottom-7 rotate-[4deg]" />
          </motion.div>
          <motion.div 
            id="startMenu" 
            ...
            transition={{duration: 0.7}}
            exit={{opacity: 0, scale: 0, transition: {duration: 0.3}}}>
              <div id="startMenuContent" className="px-6 md:px-8 py-5 md:py-10 flex flex-col gap-6 md:gap-8">
                  <div className="flex flex-col gap-3 md:gap-4">
                      <h3 className="font-bold text-xl md:text-2xl text-center">Choose Pokemon Region:</h3>
                  ...
                  <div className="flex flex-col gap-3 md:gap-4">
                      <h3 className="font-bold text-xl md:text-2xl text-center">Choose Game Difficulty:</h3>
                      <div className="grid grid-cols-3 gap-2">
